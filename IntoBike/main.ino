...
#include <IntoBike_Bluetooth_Control/IntoBike_Bluetooth_Control.h>
/*该头文件引用由IntoRobot自动添加.*/
#include <Sonar_Sensor_Processing/Sonar_Sensor_Processing.h>
/*该头文件引用由IntoRobot自动添加.*/
...
/*该头文件引用由IntoRobot自动添加.*/
#include <IntoBike_OledDisplay/IntoBike_OledDisplay.h>
/*该头文件引用由IntoRobot自动添加.*/
#include <IntoBike_AccelGyro_Sensor_Processing/IntoBike_AccelGyro_Sensor_Processing.h>
/*该头文件引用由IntoRobot自动添加.*/
#include <IntoBike_IntoRobotCloud_Interface/IntoBike_IntoRobotCloud_Interface.h>
/*
************************************************************************
* 作者:  IntoRobot Team 
* 版本:  V1.0.0
...
IntoRobotIntervalTimer    _process_timer;
...
void setup()
{
	...
	//Neutron 的STM32F411内部定时器库。包含Timer2、Timer3、Timer4、Timer5、Timer9、Timer10、Timer11定时器。
	_process_timer.begin(processTimerISR, (int)(TIMER_PERIOD*1000000), uSec,TIMER9);
}
void loop()
{
